...
function onCreate()
	...
	if not lowQuality then
		...
		scaleObject('tunnel', 6.4,4.8);
		addLuaSprite('tunnel', false);

		makeLuaSprite('POV', 'nightmare/fighting/tunnelWallPOV',300,50); --switches POV briefly
	...
	if not lowQuality then
		...
		scaleObject('gameOverScreen', 2.6,2.8);
	...
	scaleObject('healthShit', 1.35,1.35);	
...
stepHitFuncs = {
	...
	[128] = function() --testing space
		setProperty('hide.visible', false)
	...
	[1853] = function() -- P1 removed, P2 starts
		...
		if not lowQuality then
			...
			addAnimationByPrefix('fight2', 'parttwo', 'PART2 FIGHT',6,false)
			objectPlayAnimation('fight2', 'partwo',false)
			setScrollFactor('fight2', 0.9, 0.9);
			scaleObject('fight2', 1.6,1.6);
	...
	[1970] = function() -- P2 removed, crush starts
		...
		if not lowQuality then
			...
			addAnimationByPrefix('fight3', 'partthree', 'CRUSHED',12,false)
			objectPlayAnimation('fight3', 'partthree',false)
			setScrollFactor('fight3', 0.9, 0.9);
			scaleObject('fight3', 1.6,1.6);
	...
	[2848] = function() -- weakAss Jumpscare
		...
		addAnimationByPrefix('yikes', 'jump', 'scareLOL',6,false)
		objectPlayAnimation('yikes', 'jump',false)
		setScrollFactor('yikes', 0.9, 0.9);
		scaleObject('yikes', 2,2);
